...
<link href="style/dorm.css" rel="stylesheet">
...
<script type="text/javascript" src="https://cdn.bootcss.com/datatables/1.10.19/js/jquery.dataTables.js"></script>
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		...
		<div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<b style="color: saddlebrown; font-size: 1.5em;" >${currentUser.name }</b></div>
	</div>
</div>
